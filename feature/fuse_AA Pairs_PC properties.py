...
def build_fusion_cnn(params, input_shape):
    model = Sequential(name="CNN_74D_Fusion")
    model.add(Conv2D(
...
def hyperparameter_search():
    ...
    for params in param_combinations:
        model = build_fusion_cnn(params, input_shape)
...
save_pred_prob(val_ids, y_val, y_val_pred, y_val_pred_prob, "val_predictions.csv")

best_model.save(os.path.join(output_dir, "fusion_74d_cnn_best_model.h5"))